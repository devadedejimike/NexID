...
const Home = () => {
    return (
        <div className="relative overflow-hidden bg-brand-bg">
            <div className="container mx-auto px-4 py-20 md:py-25">
                <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
                    {/* Left side */}
                    <div className="space-y-8 text-center lg:text-left">
                        <div className="space-y-4">
                            <h1 className="text-4xl md:text-5xl lg:text-6xl ">Identity Made{" "} 
                                <span className="text-brand-accent bg-clip-text">Simple</span>
                            </h1>
                        ...
                        <div className="grid grid-cols-3 gap-8 pt-8 border-t border-border">
                            <div>
                                <div className="font-bold text-brand-accent text-2xl bg-clip-text">10k+</div>
                                <div className="text-sm text-brand-text-muted mt-1">Active Users</div>
                            </div>
                            <div>
                                <div className="font-bold text-brand-accent text-2xl bg-clip-text">99.9%</div>
                                <div className="text-sm text-brand-text-muted mt-1">Uptime</div>
                            </div>
                            <div>
                                <div className="font-bold text-brand-accent text-2xl bg-clip-text">{"<1s"}</div>
                                <div className="text-sm text-brand-text-muted mt-1">Active Users</div>
                            </div>
                        </div>
                    </div>
